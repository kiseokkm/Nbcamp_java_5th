...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("자식sportsCar.price = " + sportsCar.price); // 3.0E8
        System.out.println("부모sportsCar.price = " + sportsCar.getPrice()); // 5.0E7
        ...
        // super.color = color;
        // this.price = price;
        sportsCar.setCarInfo("GV80", "Black", 50000000); //부모의 GV80,Black 자식의 50000000

        // this.price = price; 결과 확인
        System.out.println("sportsCar.price = " + sportsCar.price); // 5.0E7
        System.out.println("sportsCar.price = " + sportsCar.getPrice()); // 5.0E7
